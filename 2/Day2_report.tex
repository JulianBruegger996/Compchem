...
The obtained values of the total energy, the bond lengths and the bond angle are displayed in \autoref{tab:1}
...
To visualize the impact of the geometry optimization the structure of the distorted water molecule before the geometry optimization is displayed in \autoref{fig:1}
...
The calculated potential Energy curve of Dihydrogen is plotted in \autoref{fig3}
...
The approximated dissociation energy is $D_e \approx 4.7$ eV.
